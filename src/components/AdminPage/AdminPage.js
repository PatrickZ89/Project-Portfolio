        ...
        return (
            <div>
                ...
                <form onSubmit={this.addnewProject} id="formId">
                    ...
                    <input type='text' placeholder="Website" value={this.state.newProject.website} onChange={this.handleNameChange('website')} />
                    <input type='text' placeholder="Github" value={this.state.newProject.github} onChange={this.handleNameChange('github')} />
